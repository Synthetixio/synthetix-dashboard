		...
		try {
			const chartData = chartTypes
				.map(type => {
					...
					return {
						[type]: parseChartData(action.payload.data.body[type].data, type, period),
					};
				})
			...
			return {
				...
				lastUpdated: data.HavvenMarketCap.data[data.HavvenMarketCap.data.length - 1].created,
				stats: {
					...
					havvenMarketCap:
							data.HavvenMarketCap.data[data.HavvenMarketCap.data.length - 1].usdValue,
					havvenPriceCap: data.HavvenPrice.data[data.HavvenPrice.data.length - 1].usdValue,
					havvenVolume24h:
							data.HavvenVolume24h.data[data.HavvenVolume24h.data.length - 1].usdValue,
					unlockedHavUsdBalance:
							data.UnlockedHavUsdBalance.data[data.UnlockedHavUsdBalance.data.length - 1].usdValue,
					lockedHavUsdBalance:
							data.LockedHavUsdBalance.data[data.LockedHavUsdBalance.data.length - 1].usdValue,
					lockedHavRatio: data.LockedHavRatio.data[data.LockedHavRatio.data.length - 1].usdValue,
					nominMarketCap: data.NominMarketCap.data[data.NominMarketCap.data.length - 1].usdValue,
					nominPriceCap: data.NominPrice.data[data.NominPrice.data.length - 1].usdValue,
					nominVolume24h: data.NominVolume24h.data[data.NominVolume24h.data.length - 1].usdValue,
					nominFeesCollected:
							data.NominFeesCollected.data[data.NominFeesCollected.data.length - 1].usdValue,
					networkCollateralizationRatio:
